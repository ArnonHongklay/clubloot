...
RSpec.describe PromosController, type: :controller do
  ...
  describe "GET #edit" do
    it "returns a success response" do
      promo = Promo.create! valid_attributes
      get :edit, params: {id: promo.to_param}, session: valid_session
      expect(response).to be_success
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "redirects to the created promo" do
        post :create, params: {promo: valid_attributes}, session: valid_session
        expect(response).to redirect_to(Promo.last)
      end
    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "redirects to the promo" do
        ...
        expect(response).to redirect_to(promo)
      end
    end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the promos list" do
      promo = Promo.create! valid_attributes
      delete :destroy, params: {id: promo.to_param}, session: valid_session
      expect(response).to redirect_to(promos_url)
    end
  end
